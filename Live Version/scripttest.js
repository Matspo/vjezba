...
const firstPerc = document.querySelector('.pv-1')
const secondPerc = document.querySelector('.pv-2')
const thirdPerc = document.querySelector('.pv-3')
const fourthPerc = document.querySelector('.pv-4')
